...
SOURCES = \
	__init__.py \
	d2s_browser.py d2s_browser_dialog.py

PLUGINNAME = d2s_browser

PY_FILES = \
	__init__.py \
	d2s_browser.py d2s_browser_dialog.py

UI_FILES = d2s_browser_dialog_base.ui
...
QGISDIR=/home/benh/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
